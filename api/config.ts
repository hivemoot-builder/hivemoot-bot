...
Issue #${issueNumber} isn't ready for implementation yet. This PR won't be tracked until it is.${SIGNATURE}`,
...
Issue #${issueNumber} is ready to implement, but this PR was opened before approval and was not automatically activated for implementation tracking.
